...
function Detail() {
  ...
  return <div style={{ width: '100%' }}>
      ...
      <Tabs>
        ...
        <TabPanel>
          {menu_categories[0].items.map(function (item) {
            return <div>
              <img width={350} height='100%' src={item.item_image_url} />
              <span><p>Cuisine: {item.item}</p> <h4>Price: {item.price}</h4>
    ...
    <div style={{ alignContent: 'center', display: "inline-block", width: '25%', margin: '20px', height: '100%', padding: '5px', backgroundColor: 'white', textAlign: 'center', color: 'black' }}>
    ...
    <div style={{ alignContent: 'center', display: "inline-block", width: '25%', border: '1px solid deeppink', margin: '20px', height: '100%', padding: '5px', backgroundColor: 'white', textAlign: 'center', color: 'black', borderRadius: 10 }}>
